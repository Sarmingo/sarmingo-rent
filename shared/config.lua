        ...
        vehicles = {
            {
                ...
                args = {model = 'futo', price = 250, spawncoords = vector4(433.68, 3480.04, 34.64, 289.08), account = 'money'}
            },
            {
                title = 'Blista',
                icon = 'fas fa-car',
                ...
                args = {model = 'blista', price = 350, spawncoords = vector4(433.68, 3480.04, 34.64, 289.08), account = 'money'}
            }
        }
    },
}
